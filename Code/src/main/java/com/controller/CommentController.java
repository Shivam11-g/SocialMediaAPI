...
public class CommentController {
    ...
    public ResponseEntity addlikecomment(@PathVariable int commentId,@RequestBody Likes likes) throws NoCommentFoundException {
    	try {
    		if(commentservice.addlikecommentservice(commentId, likes)!=null) {
